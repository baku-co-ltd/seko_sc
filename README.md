...
1. マイショートカットに追加された「せこせこ」の右上の<img src="menu.png" width="25px" style="border:0; box-shadow:0px 0px;">を開く
1. さらに開いた詳細画面の右上の<img src="menu.png" width="25px" style="border:0; box-shadow:0px 0px;">を開く
1. 「共有シートに表示」をONにする
